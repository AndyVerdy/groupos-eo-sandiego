---
name: groupos-sales-deck
description: "Creating personalized GroupOS HTML pitch decks for prospective clients. Use this when building a sales deck for a new organization — researches the org, customizes slides, and outputs a standalone HTML presentation deployed via GitHub Pages."
---

# GroupOS Custom Sales Deck Builder
...
Examples from the EO deck:
```html
<h1><b>Your Chapter.</b><br><b>Your App.</b><br>One Platform.</h1>
<h2><b>Events</b> That Run Themselves</h2>
<h2><b>Replace WhatsApp.</b><br>Own the Conversation.</h2>
<h2><b>Launch in Weeks,</b> Not Months</h2>
```

The bold sans-serif carries the action/punch. The thin serif carries the context/flow.

CTA slide uses full Mona Sans bold (no Lora mix):
```css
.cta-c h1{font-family:'Mona Sans',sans-serif;font-weight:800}
```
...
```
679d310dc7908524729da405_img-main-community.webp   — Cover hero
...
- **Members Map** — Screenshot from a live GroupOS community
- **White-Label** — Screenshot of the client's branded app
...
- Current tools flow (research what they use)
- 3 pain points specific to their situation

### Feature Slides (3-14)
- Keep GroupOS features accurate — ONLY use real features from groupos.com
- Customize examples to match their terminology
- Reference their specific event types and committees
...
├── members-map.png      — Members map screenshot
...
- Body class `dk` toggles for dark slides
...
- Organization name spelled correctly everywhere
